$(function () {
  ...
  $(".detox-main").on("mouseover", function () {
    $(".leaves-graph").css(
      "filter",
      "drop-shadow(0px 0px 10px rgba(129, 178, 20, 1))"
    );
  });
  ...
  $(".currently-programme-top-main-description-list").on(
    "mouseover",
    function () {
      $(".body-graph").css(
        "filter",
        "drop-shadow(0px 0px 25px rgba(255, 204, 41, 1))"
      );
    }
  );
  ...
  $(".transformation-game-description").on("mouseover", function () {
    $(".cube-graph").css(
      "filter",
      "drop-shadow(0px 0px 25px rgba(81, 18, 129, 1))"
    );
  });
